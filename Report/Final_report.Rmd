...
By using the methods described above, we can identify and estimate each of the four
outlier effects.  This enables us to build a time series model free of outliers, 
and construct accurate "outlier-free" forecasts. The tsoutliers R package allows us 
to easily obtain these outlier effect estimates and produce clear graphs displaying 
time series models contaminated with outlers vs outlier free models.
