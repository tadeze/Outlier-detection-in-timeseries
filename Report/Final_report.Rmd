...
effect is shown with four different stationary ARMA models.
...
\begin{equation}
\hat{\tau} = \frac{\hat{\omega}}{\sqrt{\sigma_a^2 / \sum_{t = t_1}^{n} x^2_t}}
\end{equation}

where $\sigma_a^2$ is the variance of $Z_t$. The $\hat{\tau}$ statistics allow for
